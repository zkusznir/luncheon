      ...
      <div className='order-box'>
        <div className='order-box__management'>
          ...
          <div className='management__orders-type'>
            <button className='btn btn-default orders-type' id='active'
                    onClick={this.handleChangeOrdersType}>Active</button>
            <button className='btn btn-default orders-type' id='history'
                    onClick={this.handleChangeOrdersType}>History</button>
          </div>
        </div>
